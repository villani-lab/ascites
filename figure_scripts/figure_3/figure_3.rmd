...
fig = python_functions.plot_feature(lin_data=dc_data,
                                    genes=['RORC', 'PIGR', 'ACY3', 'PRDM16', 'SFTPD', 'S100B', 'AIRE', 'IRF8', 'IL15'],
                                    ncol=3,
                                    nrow=3)
plt.show()
# plt.savefig("/projects/home/tlchan/fig_panels/fig_3e.pdf")
plt.close(fig)
```

## Figure 3F
```{r message = F, results = F, warning = F, fig.width = 14, fig.height = 8, fig_3F}
corr_mat <- read.csv("/projects/home/tlchan/projects/ascites/corr_human_mouse_thetis_long_norm.csv")
...
corr_mat <- corr_mat %>%
    ...
    mutate(mouse_cells = factor(mouse_cells, levels = c('DC1', 'DC2', 'migratoryDC', 'TC IV', 'Rorc-DC', 'TC II', 'TC I', 'TC III', 'newDC_human', 'tDC', 'pDC')))
...
ggplot(corr_mat, aes(x = mouse_cells, y = human_cells, fill = Nor)) +
    ...
    theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1), leg)
# ggsave("/projects/home/tlchan/fig_panels/fig_3f.pdf", width = 5, height = 5)
```

## Figure 3G
```{r message = F, results = F, warning = F, fig.width = 14, fig.height = 8, fig_3G}
# "Other" organ types
