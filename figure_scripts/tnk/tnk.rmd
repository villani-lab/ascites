...
fig = python_functions.plot_umap(lin_data=tnk_data,
...
fig = python_functions.plot_umap(lin_data=cd8_w_cite_data,
                           palette=cd8_cluster_palette)
# plt.show()
plt.savefig("/projects/home/tlchan/fig_panels/fig__b.pdf")
plt.close(fig)
```

## Figure _C
```{python results = 'hold', fig__C}
cd8_cluster_palette = {
    "1": "#FF0029",
    "2": "#377EB8",
    "3": "#66A61E",
...
fig = python_functions.plot_umap(lin_data=cd8_wo_cite_data,
                           palette=cd8_cluster_palette)
# plt.show()
plt.savefig("/projects/home/tlchan/fig_panels/fig__c.pdf")
plt.close(fig)
```

## Figure _D
```{python results = 'hold', fig__D}
cd8_w_cite_data = pg.read_input("/projects/home/tlchan/projects/ascites/data_cite_objects/cd8.zarr.zip")
...
# plt.show()
plt.savefig("/projects/home/tlchan/fig_panels/fig__d.pdf")
plt.close(fig)
```
...
fig = python_functions.plot_feature(lin_data=cd8_wo_cite_data,
                              ...
                              genes=["CD14", "cite_CD14", "cite_TCR-Vdelta2", "cite_TCR-Vgamma9"])
# plt.show()
plt.savefig("/projects/home/tlchan/fig_panels/fig__e.pdf")
plt.close(fig)
```