...
```{r message = F, results = F, warning = F, fig.width = 5.5, fig.height = 8, supp_9A}
# Load data
...
```{r message = F, results = F, warning = F, fig.width = 5.5, fig.height = 8, supp_9B}
# Load data
abundance <- read.csv("/projects/home/tlchan/projects/ascites/results/abundance/integrated_data/ascites_abundance_include_non_native.csv")
...
```{r message = F, results = F, warning = F, fig.width = 4, fig.height = 8, supp_9G}
...
```{r message = F, results = F, warning = F, fig.width = 5, fig.height = 6, supp_9H}
