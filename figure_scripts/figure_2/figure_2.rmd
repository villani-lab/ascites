...
## Figure 1D
```{r message = F, results = F, warning = F, fig.width = 14, fig.height = 10, fig_2D}
...
plot_upset(res = cd4_res,
           min_degree = 7)
ggsave("/projects/home/tlchan/fig_panels/fig_2d.pdf", width = 8, height = 8, dpi = 300)
```
...
fig = python_functions.plot_feature_by_tissue_type(lin_data=cd4_data,
                                                   genes=["CXCR3", "CXCR6"])
# plt.show()
plt.savefig("/projects/home/tlchan/fig_panels/fig_2e.pdf")
plt.close(fig)
```

## Figure 2F
```{r message = F, results = F, warning = F, fig.width = 14, fig.height = 8, fig_2F}
plot_sf_boxplot(analytes = c("CXCL12", "IL-12p40", "IL-15", "TNFα", "IFNγ"),
                nrow = 2)
ggsave("/projects/home/tlchan/fig_panels/fig_2f.pdf", width = 8, height = 8, device = cairo_pdf)
```