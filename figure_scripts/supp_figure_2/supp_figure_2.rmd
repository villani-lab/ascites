...
```{r message = F, results = F, warning = F, fig.width = 12, fig.height = 6, supp_2D}
...
```{r message = F, results = F, warning = F, fig.width = 14, fig.height = 6, supp_2E}
...
```{r message = F, results = F, warning = F, fig.width = 16, fig.height = 10, supp_2F}
