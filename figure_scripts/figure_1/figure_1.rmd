...
## Figure 1C
```{r message = F, results = F, warning = F, fig.width = 15, fig.height = 6, fig_1C}
...
bp <- ggplot(abundance, aes(x = lin_percentage + 1, y = factor(lineage), fill = tissue_type)) +
    ...
    theme(axis.text.y = element_blank(), axis.text = element_text(size = 18)) +
...
## Figure 1D
```{r message = F, results = F, warning = F, fig.width = 18, fig.height = 10, fig_1D}
# Read in metadata
