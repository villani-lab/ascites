...
## Supp table ##
n_cells$dc_type <- as.character(n_cells$dc_type)
n_cells$dc_type[n_cells$dc_type == "PRDC"] <- "DC_RORC"
write.csv(n_cells, "/projects/home/nealpsmith/projects/ascites/data/plot_data/fig_s8d.csv", row.names = FALSE)
