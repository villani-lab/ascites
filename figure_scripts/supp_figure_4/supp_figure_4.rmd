...
```{r message = F, results = F, warning = F, fig.width = 14, fig.height = 6, supp_4C}
...
```{r message = F, results = F, warning = F, fig.width = 6, fig.height = 6, supp_4D}
...
highlight_genes <-  c("CXCL1", "IL10", "CXCL8", "CSF1", "CCL2", "CCL20", "HAVCR2", "VEGFA")
...
```{r message = F, results = F, warning = F, fig.width = 4, fig.height = 18, supp_4F}
