...
# abundance %>%
# group_by(cluster) %>%
# mutate(total_cells = sum(count)) %>% mutate(perc_cells = count / total_cells * 100) %>%
# write.csv("/projects/home/nealpsmith/projects/ascites/data/plot_data/fig_s5a.csv", row.names = FALSE)
...
```{r fig_s5c, message = FALSE, warning = FALSE, fig.width = 8, fig.height = 6}
...
write.csv(scaled_data, "/projects/home/nealpsmith/projects/ascites/data/plot_data/fig_s5c.csv")
...
rss_data.to_csv("/projects/home/nealpsmith/projects/ascites/data/plot_data/fig_s5e.csv")
...
write.csv(rss_data, "/projects/home/nealpsmith/projects/ascites/data/plot_data/fig_s5f.csv")
