...
```{r message = F, results = F, warning = F, fig.width = 12, fig.height = 6, supp_5A}
...
```{r message = F, results = F, warning = F, fig.width = 12, fig.height = 6, supp_5B}
